...
.macro slowQuad4	yPixelsH, yPixelsL, xPixelsH, xPixelsL
	pla
	tax
	clc
	lda yPixelsL
...
bullet3:
bullet4:
	slowQuad4	#0, #248, #0, #112
bullet5:
bullet6:
	slowQuad4	#0, #232, #0, #160
bullet7:
bullet8:
	slowQuad4	#0, #200, #0, #200
bullet9:
bulletA:
	slowQuad4	#0, #160, #0, #232
bulletB:
bulletC:
	slowQuad4	#0, #112, #0, #248
bulletD:
bulletE:
	slowQuad4	#0, #56, #1,#0
bulletF:
