objects = bullets.o enemies.o gamepads.o lib.o main.o oam.o palettes.o playerbullets.o player.o pickups.o ppu.o scenes.o score.o sprites.o tiles.o waves.o
game = neon.nes
source = src/
builddir = build/
configfile = neon.cfg
